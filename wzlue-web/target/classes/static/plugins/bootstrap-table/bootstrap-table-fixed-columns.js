...
(function ($) {
        ...
        if(this.options.rightFixedColumns){
            if(typeof (this.options.height)!=='undefined'){
                this.$rightFixedHeader = $([
                    '<div class="fixed-table-header-columns" style="position: absolute;right:17px;background-color: #fff">',
                    '<table>',
                    '<thead></thead>',
                    '</table>',
                    '</div>'].join(''));
                ...
                this.$rightFixedHeader = $([
                    '<div class="fixed-table-header-columns" style="position: absolute;right:0px;background-color: #fff">',
                    '<table>',
                    '<thead></thead>',
                    '</table>',
                    '</div>'].join(''));
            ...
            if(typeof (this.options.height)!=='undefined'){
                this.$rightFixedBody = $([
                    '<div class="fixed-table-body-columns" style="position: absolute;right:17px;background-color: #fff;">',
                    '<table>',
                    '<tbody></tbody>',
                    '</table>',
                    '</div>'].join(''));
                ...
                this.$rightFixedBody = $([
                    '<div class="fixed-table-body-columns" style="position: absolute;right:0px;background-color: #fff;">',
                    '<table>',
                    '<tbody></tbody>',
                    '</table>',
                    '</div>'].join(''));
    ...
    BootstrapTable.prototype.fitHeaderColumns = function () {
        ...
        $('.fixed-table-header-columns').show();
        if(this.getData().length === 0) {
            $('.fixed-table-header-columns').hide();
        }
    };
